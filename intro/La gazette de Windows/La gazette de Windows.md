...
On ouvre le fichier via l'Event Viewer windows.

Un des événements contient les informations suivantes :
...
ID Scriptblock : 634cf5ca-b06b-4b5a-8354-c5ccd9d3c82a
Chemin d'accès : C:\Users\jmichel\Downloads\payload.ps1
```

On en extrait dans un fichier `payload.ps1` la partie qui permet de générer le message envoyé :
...
Et on exécute le script pour récupérer le flag :
```ps1
PS C:\FCSC_2023> ./payload.ps1
s= FCSC{98c98d98e5a546dcf6b1ea6e47602972ea1ce9ad7262464604753c4f79b3abd3}
```
